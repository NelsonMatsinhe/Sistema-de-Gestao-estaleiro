...
public class TelaProduto extends javax.swing.JInternalFrame {
    ...
    public TelaProduto() {
        ...
        for (Categoria categoria : Categoria.values()) {
            cmbCategoria.addItem(categoria.name());
        }
...
//        });
    ...
    private void initComponents() {
        ...
        jPanel6.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 320, 30));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("ID:");
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 20, -1));
        ...
        jPanel6.add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 320, 30));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Nome:");
        jPanel6.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 50, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Tempo cura:");
        jPanel6.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 80, 90, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Categoria:");
        jPanel6.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 30, 70, -1));
        ...
        jPanel6.add(txtTempoCura, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 80, 320, 30));
        ...
        jPanel6.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 200, 820, 290));
        ...
        jPanel6.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, -1, 290));
        jPanel6.add(lblMessagem, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 700, 20));

        cmbCategoria.setPreferredSize(new java.awt.Dimension(300, 30));
        cmbCategoria.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                cmbCategoriaAncestorAdded(evt);
            }
        ...
        jPanel6.add(cmbCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 30, 320, 30));
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        if (validarFormulario()) {
            // Certifique-se de que o produto foi instanciado corretamente
            if (produto == null) {
                produto = new Produto();
            }
            int tempoCura = 0;
            produto.setNome(txtNome.getText());
            produto.setCategoria(Categoria.valueOf(cmbCategoria.getSelectedItem().toString()));
            produto.setDataRegistro(new Date());
            produto.setTempoCura((Integer) txtTempoCura.getValue());

            // Verificar se o id é nulo e inicializá-lo se for o caso
            if (produto.getId() == 0) {  // Novo produto
                try {
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        if (!txtID.getText().isEmpty()) {
            ...
            if (confirmacao == JOptionPane.YES_OPTION) {
                try {
                    produtoDAO.remover(id);  // Desativa o produto
                    JOptionPane.showMessageDialog(this, "Produto desativado com sucesso.");
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(this, "Erro ao desativar o produto.\n" + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                }
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        if (validarFormulario()) {
            ...
            if (produto != null) {
                ...
                JOptionPane.showMessageDialog(this, "Produto não encontrado para edição.");
            }
        } else {
    ...
    private void cmbCategoriaAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_cmbCategoriaAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbCategoriaAncestorAdded
    ...
    public void selectRegistryTable() {
        ...
        if (selectedRow != -1) {
            txtID.setText(TbProduto.getValueAt(selectedRow, 0).toString());
            txtNome.setText(TbProduto.getValueAt(selectedRow, 1).toString());
            txtTempoCura.setValue(TbProduto.getValueAt(selectedRow, 2));
            String Categoria = TbProduto.getValueAt(selectedRow, 3).toString();
            for (int i = 0; i < cmbCategoria.getItemCount(); i++) {
                if (cmbCategoria.getItemAt(i).toString().equals(Categoria)) {
    ...
    private void limpaFormulario() {
        txtID.setText("");
        txtNome.setText("");
        cmbCategoria.setSelectedIndex(-1); // Deseleciona a categoria no JComboBox
        txtTempoCura.setValue(0); // Resetando o tempo de cura
        //txtQuantidade.setValue(0); // Resetando a quantidade
    }
